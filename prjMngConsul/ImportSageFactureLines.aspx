<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="ImportSageFactureLines.aspx.vb" Inherits="MngConsul.ImportSageFactureLines" %>

<asp:Content ID="titleContent" ContentPlaceHolderID="TitleContent" runat="server">
    Import Lignes de Factures
</asp:Content>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="toolbar">
        <div class="pg-header">
            ...
            <div>
                <h1>Import Lignes de Factures</h1>
                <div class="pg-sub">Migration Sage 50 → staging.SageFactureLines</div>
            </div>
        </div>
    </div>
    ...
    <asp:Panel ID="pnlUpload" runat="server">
        <div class="imp-section">
            ...
            <p class="sec-desc">Exportez depuis Sage 50 : <strong>Reports &gt; Receivables / Payables &gt; Invoice Detail</strong></p>
    ...
    <div class="imp-section">
        ...
        <table class="map-tbl">
            ...
            <tbody>
                <tr><td class="c-csv">Invoice Number</td><td class="c-arr">→</td><td class="c-db">SageDocNumber</td><td>VARCHAR(200)</td><td>Numéro de facture parent</td></tr>
                <tr><td class="c-csv">Description</td><td class="c-arr">→</td><td class="c-db">SageLineDesc</td><td>VARCHAR(1000)</td><td>Description de la ligne</td></tr>
                <tr><td class="c-csv">Quantity</td><td class="c-arr">→</td><td class="c-db">SageQty</td><td>DECIMAL(18,4)</td><td>Quantité</td></tr>
                <tr><td class="c-csv">Unit Price</td><td class="c-arr">→</td><td class="c-db">SageUnitPrice</td><td>DECIMAL(18,4)</td><td>Prix unitaire</td></tr>
                <tr><td class="c-csv">Amount</td><td class="c-arr">→</td><td class="c-db">SageAmount</td><td>DECIMAL(18,4)</td><td>Montant de la ligne</td></tr>
                <tr><td class="c-csv">GL Account</td><td class="c-arr">→</td><td class="c-db">SageCompteComptable</td><td>VARCHAR(20)</td><td>Compte comptable</td></tr>
                <tr><td class="c-csv">Tax Code</td><td class="c-arr">→</td><td class="c-db">SageTaxeCode</td><td>VARCHAR(20)</td><td>Code taxe (TPS_TVQ, EXEMPT...)</td></tr>
            </tbody>
        </table>
    </div>
