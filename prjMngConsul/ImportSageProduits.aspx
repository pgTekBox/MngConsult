<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="ImportSageProduits.aspx.vb" Inherits="MngConsul.ImportSageProduits" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="toolbar">
        <div class="pg-header">
            ...
            <div>
                <h1>Import Produits / Services</h1>
                <div class="pg-sub">Migration Sage 50 → staging.SageProduits</div>
            </div>
        </div>
    </div>
    ...
    <asp:Panel ID="pnlUpload" runat="server">
        <div class="imp-section">
            ...
            <p class="sec-desc">Exportez depuis Sage 50 : <strong>Reports &gt; Lists &gt; Inventory &amp; Services</strong></p>
    ...
    <div class="imp-section">
        ...
        <table class="map-tbl">
            ...
            <tbody>
                <tr><td class="c-csv">Item Name</td><td class="c-arr">→</td><td class="c-db">SageName</td><td>VARCHAR(500)</td><td>Nom du produit/service</td></tr>
                <tr><td class="c-csv">Description</td><td class="c-arr">→</td><td class="c-db">SageDescription</td><td>VARCHAR(2000)</td><td>Description</td></tr>
                <tr><td class="c-csv">Price</td><td class="c-arr">→</td><td class="c-db">SagePrice</td><td>DECIMAL(18,2)</td><td>Prix de vente</td></tr>
                <tr><td class="c-csv">Revenue Account</td><td class="c-arr">→</td><td class="c-db">SageCompteVente</td><td>VARCHAR(20)</td><td>Compte de vente</td></tr>
                <tr><td class="c-csv">Expense Account</td><td class="c-arr">→</td><td class="c-db">SageCompteAchat</td><td>VARCHAR(20)</td><td>Compte d'achat</td></tr>
                <tr><td class="c-csv">Taxable</td><td class="c-arr">→</td><td class="c-db">SageTaxable</td><td>VARCHAR(10)</td><td>Oui / Non</td></tr>
            </tbody>
        </table>
    </div>
