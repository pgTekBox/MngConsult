<%@ Page Title="Courriel" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/Site.Master" CodeBehind="wbfMailbox.aspx.vb"
    Inherits="MngConsul.wbfMailbox" %>

<asp:Content ID="cTitle" ContentPlaceHolderID="TitleContent" runat="server">Courriel</asp:Content>
...
<asp:Content ID="cHead" ContentPlaceHolderID="HeadContent" runat="server">
    <style>
        ...
        .mail-head { display: flex; align-items: center; gap: 12px; margin: 0 0 14px; flex-wrap: wrap; }
        .mail-head h1 { font-size: 22px; font-weight: 900; margin: 0; }
        .mail-addr { font-weight: 800; color: #2563eb; background: #eff6ff; border: 1px solid #dbeafe; padding: 5px 12px; border-radius: 999px; font-size: 14px; }
        ...
        .compose .from-note { font-size: 13px; color: #0f172a; margin-top: 2px; font-weight: 700; }
...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContent" runat="server">
    <div class="mail-wrap">
        <div class="mail-head">
            <h1>✉️ Courriel</h1>
            <span class="mail-addr"><asp:Literal ID="litAddr" runat="server" /></span>
        </div>
        ...
        <asp:Panel ID="pnlCompose" runat="server" Visible="false">
            <div class="compose">
                <label>De</label>
                <div class="from-note"><asp:Literal ID="litComposeFrom" runat="server" /></div>
                ...
                <div class="from-note" style="font-weight:600;color:#64748b;">Vous pouvez sélectionner plusieurs fichiers (50 Mo max au total).</div>
