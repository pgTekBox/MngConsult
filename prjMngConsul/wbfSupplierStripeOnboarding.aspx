        ...
        <div class="layout">
            ...
            <div class="card">
                ...
                <asp:Panel ID="pnlStatusNew" runat="server" Visible="false" CssClass="status-box not-configured">
                    <div class="status-title">⚠ Paiements non configurés</div>
                    Ce fournisseur n'a pas encore de compte Stripe Connect.
                    Cliquez sur le bouton ci-dessous pour démarrer l'inscription.
                </asp:Panel>

                <!-- État : onboarding en cours -->
                <asp:Panel ID="pnlStatusPending" runat="server" Visible="false" CssClass="status-box pending">
                    <div class="status-title">⏳ Inscription en cours</div>
                    Le fournisseur a démarré son inscription Stripe mais ne l'a pas complétée.
                ...
                <asp:Panel ID="pnlStatusActive" runat="server" Visible="false" CssClass="status-box active">
                    <div class="status-title">✓ Compte actif</div>
                    Ce fournisseur peut recevoir des paiements via MngConsul.
                ...
                <asp:Panel ID="pnlStatusRestricted" runat="server" Visible="false" CssClass="status-box restricted">
                    <div class="status-title">⚠ Action requise</div>
                ...
                <ul class="features">
                    <li>
                        ...
                        Recevoir des paiements par carte de crédit, Interac et ACSS Debit
                    </li>
                    <li>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Versement automatique dans votre compte bancaire (1-2 jours)
                    </li>
                    <li>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                        Sécurité maximale (PCI-DSS, conforme Paiements Canada)
                    </li>
                    <li>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>
                ...
                <asp:Panel ID="pnlModeChoice" runat="server" Visible="false">
                    ...
                    <h3 style="font-size: 13px; font-weight: 800; color: var(--slate-700); text-transform: uppercase; letter-spacing: .08em; margin: 24px 0 12px 0;">
                        Choisir comment inscrire ce fournisseur
                    </h3>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr; gap: 12px; margin-bottom: 16px;">
                        ...
                        <div style="background: #fff; border: 2px solid var(--slate-200); border-radius: 12px; padding: 16px 18px;">
                            ...
                            <div style="font-size: 12px; color: var(--slate-500); margin-bottom: 10px;">
                                Vous serez redirigé vers Stripe pour remplir les informations du fournisseur.
                                Utile si vous avez toutes ses infos (NEQ, banque, etc.) ou s'il est avec vous.
                            </div>
                        ...
                        <div style="background: #fff; border: 2px solid var(--slate-200); border-radius: 12px; padding: 16px 18px;">
                            <div style="font-weight: 800; font-size: 14px; margin-bottom: 4px;">
                                ✉️ Envoyer une invitation par courriel
                            </div>
                            <div style="font-size: 12px; color: var(--slate-500); margin-bottom: 10px;">
                                Le fournisseur reçoit un courriel avec un lien sécurisé. Il remplit
                                lui-même ses informations sur Stripe.
                                <strong>Recommandé en B2B</strong>.
                            </div>
                ...
                <asp:Panel ID="pnlInvitationSent" runat="server" Visible="false"
                    ...
                    <div class="status-title">✓ Invitation envoyée</div>
                    Un courriel a été envoyé à <strong><asp:Literal ID="litInvitationEmailSent" runat="server" /></strong>
                    avec le lien d'inscription Stripe Connect.
                    Vous serez notifié quand le fournisseur aura complété son inscription.
                </asp:Panel>
