<%@ Page Language="vb" AutoEventWireup="false"
    CodeBehind="wbfSupplierPaymentSuccess.aspx.vb" Inherits="MngConsul.wbfSupplierPaymentSuccess" %>
...
<head runat="server">
    ...
    <title>Paiement fournisseur réussi — MngConsul</title>
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .card-top { padding: 48px 32px 32px 32px; }
    ...
    <form id="form1" runat="server">
        ...
        <div class="card">
            ...
            <div class="card-top">
                ...
                <p class="subtitle">
                    Le paiement à <strong><asp:Literal ID="litSupplierName" runat="server" /></strong>
                ...
                <div class="receipt">
                    ...
                    <div class="receipt-row">
                        <span class="lbl">Facture</span>
                        <span class="val">
                            <asp:Literal ID="litDocumentId" runat="server" />
                        </span>
                    </div>
                    ...
                    <div class="receipt-row">
                        ...
                        <span class="val">
                            <asp:Literal ID="litMethod" runat="server" />
                        </span>
                    </div>

                    <div class="receipt-row">
                        <span class="lbl">N° transaction</span>
                    ...
                    <div class="receipt-row">
                        <span class="lbl">Frais Stripe</span>
                        <span class="val">
                            <asp:Literal ID="litFees" runat="server" />
                        </span>
                    </div>
            ...
            <asp:Panel ID="pnlWarning" runat="server" Visible="false" CssClass="alert">
                ⏳ Le paiement est en cours de traitement. La confirmation peut prendre quelques minutes.
            </asp:Panel>

            <div class="actions">
                <asp:HyperLink ID="lnkBack" runat="server"
                    NavigateUrl="~/wbfSuppliersInvoices.aspx" CssClass="btn">
                    Retour aux factures →
                </asp:HyperLink>
            </div>

            <div class="footer-info">
                Le règlement est automatiquement enregistré dans votre comptabilité.
            </div>
