...
<body class="font-sans antialiased bg-white text-slate-900">
    ...
    <main>
        <div class="page" data-page="accueil">
            <!-- ============ HERO (lf) ============ -->
            <section class="relative min-h-screen bg-gradient-to-br from-slate-50 via-sky-50/60 to-white flex items-center overflow-hidden">
                <div class="absolute inset-0">
                    <div class="absolute top-0 left-1/4 w-96 h-96 bg-sky-400/15 rounded-full blur-3xl"></div>
                    <div class="absolute bottom-0 right-1/4 w-96 h-96 bg-blue-400/10 rounded-full blur-3xl"></div>
                    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-sky-100/40 rounded-full blur-3xl"></div>
                </div>
                <div class="absolute inset-0 bg-[linear-gradient(to_right,rgba(148,163,184,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.06)_1px,transparent_1px)] bg-[size:64px_64px]"></div>
                <div class="relative max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-16 lg:pt-32 lg:pb-24">
                    <div class="flex flex-col items-center text-center">
                        <div class="max-w-4xl">
                            <div class="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-700 text-sm font-medium px-4 py-2 rounded-full mb-8">
                                <i data-lucide="zap" class="w-4 h-4 fill-blue-600"></i>Une première au Québec et au Canada
                            </div>
                            <h1 class="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-slate-950 leading-[1.08] tracking-tight mb-6">La gestion financière <span class="relative"><span class="text-blue-600">100% automatisée</span></span> pour les PME &amp; les Travailleurs Autonomes</h1>
                            <p class="text-lg lg:text-xl text-slate-600 leading-relaxed mb-10 max-w-2xl mx-auto">60sec-AI révolutionne l'administration des PME &amp; des Travailleurs Autonomes grâce à une intelligence artificielle qui automatise votre comptabilité, vos remises et vos états financiers — en temps réel, sans effort.</p>
                            <div class="flex flex-col sm:flex-row items-center gap-4 justify-center mb-12">
                                <a data-nav="accueil" href="#plans" class="group w-full sm:w-auto flex items-center justify-center gap-2 bg-blue-700 hover:bg-blue-600 text-white font-semibold px-8 py-4 rounded-xl text-base transition-all duration-200 hover:shadow-2xl hover:shadow-blue-700/30 hover:-translate-y-0.5">Commencer gratuitement<i data-lucide="arrow-right" class="w-5 h-5 group-hover:translate-x-1 transition-transform"></i></a>
                                <a href="#solution" class="group w-full sm:w-auto flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-800 font-semibold px-8 py-4 rounded-xl text-base border border-slate-200 hover:border-slate-300 transition-all duration-200 shadow-sm"><i data-lucide="play" class="w-4 h-4 fill-slate-700"></i>Voir la démo</a>
                            </div>
                            <div class="flex items-center justify-center gap-6 text-sm text-slate-500">
                                <div class="flex items-center gap-2"><i data-lucide="shield" class="w-4 h-4 text-emerald-500"></i>Sécurisé et conforme</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- ============ PROBLEM (of) ============ -->
            <section id="problem" class="bg-white py-24 lg:py-32">
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    <div class="max-w-3xl mx-auto text-center mb-16">
                        <div class="inline-flex items-center gap-2 bg-rose-50 border border-rose-100 text-rose-600 text-sm font-medium px-4 py-2 rounded-full mb-6"><i data-lucide="alert-triangle" class="w-4 h-4"></i>Le problème réel des PME &amp; des Travailleurs Autonomes</div>
                        <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-950 tracking-tight mb-6">Les PME &amp; les Travailleurs Autonomes ont les mêmes obligations <span class="text-rose-500">que les grandes entreprises</span></h2>
                        <p class="text-lg text-slate-600 leading-relaxed">Pourtant, les solutions intégrées demeurent trop complexes ou trop coûteuses pour des entreprises qui représentent <strong>90 % du tissu économique canadien.</strong></p>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
                        <div class="group flex items-start gap-4 p-5 bg-slate-50 hover:bg-slate-100 rounded-2xl border border-slate-100 hover:border-slate-200 transition-all duration-200">
                            <div class="w-11 h-11 bg-rose-100 group-hover:bg-rose-200 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="users" class="w-5 h-5 text-rose-500"></i></div>
                            <div><p class="font-semibold text-slate-900 text-sm mb-0.5">Gestion des rendez-vous clients</p><p class="text-slate-500 text-xs leading-relaxed">Agenda, gestion des rappels</p></div>
                        </div>
                        <div class="group flex items-start gap-4 p-5 bg-slate-50 hover:bg-slate-100 rounded-2xl border border-slate-100 hover:border-slate-200 transition-all duration-200">
                            <div class="w-11 h-11 bg-rose-100 group-hover:bg-rose-200 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="book-open" class="w-5 h-5 text-rose-500"></i></div>
                            <div><p class="font-semibold text-slate-900 text-sm mb-0.5">Livres comptables</p><p class="text-slate-500 text-xs leading-relaxed">Journal, grand livre, balance</p></div>
                        </div>
                        <div class="group flex items-start gap-4 p-5 bg-slate-50 hover:bg-slate-100 rounded-2xl border border-slate-100 hover:border-slate-200 transition-all duration-200">
                            <div class="w-11 h-11 bg-rose-100 group-hover:bg-rose-200 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="file-text" class="w-5 h-5 text-rose-500"></i></div>
                            <div><p class="font-semibold text-slate-900 text-sm mb-0.5">Facturation client</p><p class="text-slate-500 text-xs leading-relaxed">Création, envoi, suivi des paiements</p></div>
                        </div>
                        <div class="group flex items-start gap-4 p-5 bg-slate-50 hover:bg-slate-100 rounded-2xl border border-slate-100 hover:border-slate-200 transition-all duration-200">
                            <div class="w-11 h-11 bg-rose-100 group-hover:bg-rose-200 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="credit-card" class="w-5 h-5 text-rose-500"></i></div>
                            <div><p class="font-semibold text-slate-900 text-sm mb-0.5">Paiements fournisseurs</p><p class="text-slate-500 text-xs leading-relaxed">Approbation, paiement, réconciliation</p></div>
                        </div>
                        <div class="group flex items-start gap-4 p-5 bg-slate-50 hover:bg-slate-100 rounded-2xl border border-slate-100 hover:border-slate-200 transition-all duration-200">
                            <div class="w-11 h-11 bg-rose-100 group-hover:bg-rose-200 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="receipt" class="w-5 h-5 text-rose-500"></i></div>
                            <div><p class="font-semibold text-slate-900 text-sm mb-0.5">Remises gouvernementales</p><p class="text-slate-500 text-xs leading-relaxed">TPS/TVQ, DAS</p></div>
                        </div>
                        <div class="group flex items-start gap-4 p-5 bg-slate-50 hover:bg-slate-100 rounded-2xl border border-slate-100 hover:border-slate-200 transition-all duration-200">
                            <div class="w-11 h-11 bg-rose-100 group-hover:bg-rose-200 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="piggy-bank" class="w-5 h-5 text-rose-500"></i></div>
                            <div><p class="font-semibold text-slate-900 text-sm mb-0.5">Gestion de trésorerie</p><p class="text-slate-500 text-xs leading-relaxed">Flux, prévisions, liquidités</p></div>
                        </div>
                    </div>
                    <div class="bg-gradient-to-br from-slate-950 to-slate-900 rounded-3xl p-8 lg:p-12 text-center relative overflow-hidden">
                        <div class="absolute inset-0 bg-[linear-gradient(to_right,rgba(148,163,184,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.03)_1px,transparent_1px)] bg-[size:32px_32px]"></div>
                        <div class="relative">
                            <p class="text-4xl lg:text-5xl font-bold text-white mb-4">Résultat :</p>
                            <p class="text-xl lg:text-2xl text-slate-300 leading-relaxed max-w-2xl mx-auto">Des entrepreneurs <span class="text-rose-400 font-semibold">débordés</span>, freinés par une lourdeur administrative qui nuit directement à leur <span class="text-amber-400 font-semibold">productivité</span> et à leur <span class="text-emerald-400 font-semibold">croissance</span>.</p>
                            <div class="mt-8 inline-block bg-amber-400/10 border border-amber-400/20 text-amber-300 px-6 py-3 rounded-xl text-base font-semibold">60sec-AI met fin à ce non-sens.</div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- ============ SOLUTION (df) ============ -->
            <section id="solution" class="bg-slate-50 py-24 lg:py-32">
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    <div class="max-w-3xl mx-auto text-center mb-20">
                        <div class="inline-flex items-center gap-2 bg-sky-50 border border-sky-100 text-sky-600 text-sm font-medium px-4 py-2 rounded-full mb-6"><i data-lucide="zap" class="w-4 h-4"></i>La solution 60sec-AI</div>
                        <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-950 tracking-tight mb-6">Contrairement aux outils actuels, <span class="text-sky-600">60sec-AI offre une intégration complète</span></h2>
                        <p class="text-lg text-slate-600 leading-relaxed">Tout est centralisé, automatisé et pensé pour l'entrepreneur, pas pour les spécialistes.</p>
                    </div>
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24">
                        <div class="space-y-4">
                            <div class="flex items-start gap-3"><i data-lucide="check-circle" class="w-5 h-5 text-emerald-500 flex-shrink-0 mt-0.5 fill-emerald-50"></i><p class="text-slate-700 font-medium">Intégration complète de toutes les fonctions administratives</p></div>
                            <div class="flex items-start gap-3"><i data-lucide="check-circle" class="w-5 h-5 text-emerald-500 flex-shrink-0 mt-0.5 fill-emerald-50"></i><p class="text-slate-700 font-medium">Intelligence artificielle qui vous guide en temps réel</p></div>
                            <div class="flex items-start gap-3"><i data-lucide="check-circle" class="w-5 h-5 text-emerald-500 flex-shrink-0 mt-0.5 fill-emerald-50"></i><p class="text-slate-700 font-medium">États financiers générés automatiquement</p></div>
                            <div class="flex items-start gap-3"><i data-lucide="check-circle" class="w-5 h-5 text-emerald-500 flex-shrink-0 mt-0.5 fill-emerald-50"></i><p class="text-slate-700 font-medium">Remises gouvernementales soumises sans intervention</p></div>
                            <div class="flex items-start gap-3"><i data-lucide="check-circle" class="w-5 h-5 text-emerald-500 flex-shrink-0 mt-0.5 fill-emerald-50"></i><p class="text-slate-700 font-medium">Zéro dépendance à un comptable externe</p></div>
                            <div class="flex items-start gap-3"><i data-lucide="check-circle" class="w-5 h-5 text-emerald-500 flex-shrink-0 mt-0.5 fill-emerald-50"></i><p class="text-slate-700 font-medium">Tableau de bord centralisé, pensé pour l'entrepreneur</p></div>
                            <div class="pt-4"><a href="#cta" class="inline-flex items-center gap-2 bg-blue-700 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-blue-700/20 group">Découvrir la plateforme<i data-lucide="arrow-right" class="w-4 h-4 group-hover:translate-x-1 transition-transform"></i></a></div>
                        </div>
                        <div class="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-xl shadow-slate-200/50">
                            <div class="bg-slate-950 px-6 py-4"><p class="text-slate-300 text-sm font-medium">Comparaison de marché</p></div>
                            <div class="divide-y divide-slate-100">
                                <div class="grid grid-cols-3 gap-4 px-5 py-3 bg-slate-50">
                                    <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Critère</p>
                                    <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider text-center">Autres outils</p>
                                    <p class="text-xs font-semibold text-amber-600 uppercase tracking-wider text-center">60sec-AI</p>
                                </div>
                                <div class="grid grid-cols-3 gap-4 px-5 py-4 hover:bg-slate-50 transition-colors">
                                    <p class="text-sm font-semibold text-slate-800">Intégration</p>
                                    <p class="text-xs text-slate-500 text-center leading-relaxed">Outils partiels, silos</p>
                                    <p class="text-xs text-emerald-600 font-medium text-center leading-relaxed">Tout centralisé en un seul endroit</p>
                                </div>
                                <div class="grid grid-cols-3 gap-4 px-5 py-4 hover:bg-slate-50 transition-colors">
                                    <p class="text-sm font-semibold text-slate-800">Automatisation</p>
                                    <p class="text-xs text-slate-500 text-center leading-relaxed">Saisie manuelle requise</p>
                                    <p class="text-xs text-emerald-600 font-medium text-center leading-relaxed">100% automatisé par IA</p>
                                </div>
                                <div class="grid grid-cols-3 gap-4 px-5 py-4 hover:bg-slate-50 transition-colors">
                                    <p class="text-sm font-semibold text-slate-800">Assistance</p>
                                    <p class="text-xs text-slate-500 text-center leading-relaxed">Manuel PDF, support limité</p>
                                    <p class="text-xs text-emerald-600 font-medium text-center leading-relaxed">IA conversationnelle en temps réel</p>
                                </div>
                                <div class="grid grid-cols-3 gap-4 px-5 py-4 hover:bg-slate-50 transition-colors">
                                    <p class="text-sm font-semibold text-slate-800">Coût</p>
                                    <p class="text-xs text-slate-500 text-center leading-relaxed">Abonnements multiples + comptable</p>
                                    <p class="text-xs text-emerald-600 font-medium text-center leading-relaxed">Un seul abonnement accessible</p>
                                </div>
                                <div class="grid grid-cols-3 gap-4 px-5 py-4 hover:bg-slate-50 transition-colors">
                                    <p class="text-sm font-semibold text-slate-800">Complexité</p>
                                    <p class="text-xs text-slate-500 text-center leading-relaxed">Conçu pour les spécialistes</p>
                                    <p class="text-xs text-emerald-600 font-medium text-center leading-relaxed">Pensé pour l'entrepreneur</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <div class="bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-lg hover:shadow-slate-100 transition-all duration-300 hover:-translate-y-1">
                            <div class="w-12 h-12 bg-sky-50 text-sky-600 rounded-xl flex items-center justify-center mb-5"><i data-lucide="brain" class="w-6 h-6"></i></div>
                            <h3 class="font-bold text-slate-900 mb-2">IA conversationnelle</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Posez vos questions en français, obtenez des réponses claires sur vos finances — à toute heure.</p>
                        </div>
                        <div class="bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-lg hover:shadow-slate-100 transition-all duration-300 hover:-translate-y-1">
                            <div class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center mb-5"><i data-lucide="bar-chart-3" class="w-6 h-6"></i></div>
                            <h3 class="font-bold text-slate-900 mb-2">États financiers en temps réel</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Bilan, résultats, flux de trésorerie — générés automatiquement, toujours à jour.</p>
                        </div>
                        <div class="bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-lg hover:shadow-slate-100 transition-all duration-300 hover:-translate-y-1">
                            <div class="w-12 h-12 bg-amber-50 text-amber-600 rounded-xl flex items-center justify-center mb-5"><i data-lucide="clock" class="w-6 h-6"></i></div>
                            <h3 class="font-bold text-slate-900 mb-2">Remises automatiques</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">TPS/TVQ, DAS, acomptes provisionnels — calculés et soumis sans votre intervention.</p>
                        </div>
                        <div class="bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-lg hover:shadow-slate-100 transition-all duration-300 hover:-translate-y-1">
                            <div class="w-12 h-12 bg-slate-100 text-slate-700 rounded-xl flex items-center justify-center mb-5"><i data-lucide="zap" class="w-6 h-6"></i></div>
                            <h3 class="font-bold text-slate-900 mb-2">Tout en moins de 60 secondes</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Accédez à l'état complet de votre entreprise en quelques secondes, à tout moment.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="features" class="bg-white py-24 lg:py-32">
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    <div class="max-w-3xl mx-auto text-center mb-16">
                        <div class="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-100 text-emerald-600 text-sm font-medium px-4 py-2 rounded-full mb-6">Fonctionnalités complètes</div>
                        <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-950 tracking-tight mb-6">Toute votre administration. <span class="text-emerald-600">Un seul endroit.</span></h2>
                        <p class="text-lg text-slate-600 leading-relaxed">60sec-AI couvre l'ensemble des obligations administratives de votre PME &amp; des Travailleurs Autonomes — sans compromis, sans modules supplémentaires, sans surprise.</p>
                    </div>
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="users" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Ressources humaines</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Paie automatisée</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Calcul automatique des salaires, déductions, DAS et talons de paie. Conformité garantie avec les lois du travail.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-sky-100 text-sky-700">Populaire</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="file-text" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Facturation</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Facturation intelligente</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Créez, envoyez et suivez vos factures. L'IA relance automatiquement les comptes en souffrance et met à jour votre comptabilité.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="credit-card" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Fournisseurs</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Paiements fournisseurs</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Centralisez vos factures fournisseurs, approuvez les paiements et réconciliez automatiquement avec votre grand livre.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-700">Clé</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="receipt" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Gouvernement</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Remises gouvernementales</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">TPS/TVQ, DAS, acomptes provisionnels — tout est calculé, préparé et soumis automatiquement aux bonnes dates.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="book-open" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Comptabilité</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Livres comptables automatiques</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Chaque transaction est automatiquement journalisée, classifiée et reportée. Vos états financiers sont toujours prêts.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="piggy-bank" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Trésorerie</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Gestion des liquidités</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Visualisez vos flux en temps réel, anticipez les manques de liquidités et optimisez votre trésorerie grâce à l'IA.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-slate-100 text-slate-700">IA</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="book-open" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Intelligence artificielle</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Assistant IA en temps réel</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Posez n'importe quelle question sur vos finances en français. L'IA vous répond, vous guide et prend des actions pour vous.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="piggy-bank" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Alertes intelligentes</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Notifications proactives</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Recevez des alertes avant les échéances fiscales, les dépassements budgétaires et les anomalies dans vos finances.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-blue-50 text-blue-700">Nouveau</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="message-square" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Gestion clients</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">CRM &amp; Agenda intégré</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Gérez vos clients, vos contacts et vos rendez-vous dans un seul espace. L'agenda est optionnel — activez-le selon vos besoins.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-blue-50 text-blue-700">Nouveau</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="bell" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Ressources humaines</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Portail employé</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Chaque employé accède à ses talons de paie, ses congés, ses documents RH et son horaire — sans passer par vous.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-blue-50 text-blue-700">Nouveau</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="calendar-days" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Communication</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Notifications en temps réel</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Envoyez des alertes, des messages et des annonces à vos employés ou clients directement depuis la plateforme — instantanément.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-700">Clé</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="user-cog" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Réconciliation</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Réconciliation financière &amp; bancaire</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Chaque transaction est rapprochée automatiquement avec vos relevés bancaires en temps réel — pour des états financiers toujours exacts.</p>
                        </div>
                        <div class="group relative bg-slate-50 hover:bg-white rounded-2xl p-6 border border-slate-100 hover:border-slate-200 hover:shadow-xl hover:shadow-slate-100/80 transition-all duration-300 hover:-translate-y-1 cursor-default">
                            <span class="absolute top-4 right-4 text-xs font-semibold px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-700">Clé</span>
                            <div class="w-11 h-11 bg-slate-200 group-hover:bg-slate-950 rounded-xl flex items-center justify-center mb-5 transition-colors duration-300"><i data-lucide="radio" class="w-5 h-5 text-slate-600 group-hover:text-white transition-colors duration-300"></i></div>
                            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Comptabilité</p>
                            <h3 class="font-bold text-slate-900 mb-3 text-base leading-tight">Plan comptable complet</h3>
                            <p class="text-slate-500 text-sm leading-relaxed">Démarrez chaque nouvelle année financière en un clic — soldes d'ouverture repris automatiquement, même si vous venez d'un autre système comptable externe.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <!-- ============ PRICING (gf) ============ -->
            <section id="plans" class="bg-white py-24 lg:py-32">
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    <div class="max-w-3xl mx-auto text-center mb-16">
                        <div class="inline-flex items-center gap-2 bg-sky-50 border border-sky-100 text-sky-600 text-sm font-medium px-4 py-2 rounded-full mb-6">Conçu pour les entreprises de 0 à 9 employés &amp; les Travailleurs Autonomes</div>
                        <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-950 tracking-tight mb-6">Un plan taillé <span class="text-sky-600">sur mesure</span> pour votre réalité</h2>
                        <p class="text-lg text-slate-600 leading-relaxed">Que vous soyez Travailleur Autonome, entrepreneur incorporé ou à la tête d'une petite équipe, 60sec-AI s'adapte exactement à votre structure — sans payer pour ce dont vous n'avez pas besoin.</p>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                            <asp:Repeater ID="rptPlans" runat="server">
                                <ItemTemplate>
                                    <%# RenderPlanCard(Container.DataItem) %>
                                </ItemTemplate>
                            </asp:Repeater>
                    </div>
                    <p class="text-center text-slate-400 text-sm mt-10">Tous les plans incluent un essai gratuit. Aucune carte de crédit requise. Annulation à tout moment.</p>
                </div>
            </section>

            <!-- ============ MISSION (yf) ============ -->
            <section id="mission" class="bg-slate-50 py-24 lg:py-32 relative overflow-hidden">
                <div class="absolute inset-0 bg-[linear-gradient(to_right,rgba(148,163,184,0.06)_1px,transparent_1px),linear-gradient(to_bottom,rgba(148,163,184,0.06)_1px,transparent_1px)] bg-[size:64px_64px]"></div>
                <div class="absolute top-0 right-0 w-[600px] h-[600px] bg-sky-200/30 rounded-full blur-3xl"></div>
                <div class="absolute bottom-0 left-0 w-[400px] h-[400px] bg-blue-100/40 rounded-full blur-3xl"></div>
                <div class="relative max-w-7xl mx-auto px-6 lg:px-8">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        <div>
                            <div class="inline-flex items-center gap-2 bg-blue-50 border border-blue-200 text-blue-700 text-sm font-medium px-4 py-2 rounded-full mb-8">Notre mission</div>
                            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-950 tracking-tight mb-6 leading-tight">Les PME &amp; les Travailleurs Autonomes sont le moteur de la prospérité économique canadienne</h2>
                            <p class="text-lg text-slate-600 leading-relaxed mb-8">En les soutenant concrètement, nous encourageons leur croissance, leur pérennité et leur réussite. 60sec-AI n'est pas qu'un outil.</p>
                            <div class="bg-blue-50 border-l-4 border-blue-500 pl-6 py-4 rounded-r-xl">
                                <p class="text-xl font-bold text-slate-900 mb-1">60sec-AI est un partenaire de croissance</p>
                                <p class="text-slate-500">pour les entrepreneurs d'aujourd'hui.</p>
                            </div>
                        </div>
                        <div class="space-y-6">
                            <div class="group flex items-start gap-5 bg-white hover:bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-all duration-200 shadow-sm hover:shadow-md">
                                <div class="w-12 h-12 bg-blue-50 group-hover:bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="clock" class="w-6 h-6 text-blue-600"></i></div>
                                <div><h3 class="font-bold text-slate-900 mb-2">Libérer les entrepreneurs</h3><p class="text-slate-500 text-sm leading-relaxed">Éliminer les tâches administratives répétitives pour que vous puissiez vous concentrer sur ce qui compte : développer votre entreprise.</p></div>
                            </div>
                            <div class="group flex items-start gap-5 bg-white hover:bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-all duration-200 shadow-sm hover:shadow-md">
                                <div class="w-12 h-12 bg-blue-50 group-hover:bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="trending-up" class="w-6 h-6 text-blue-600"></i></div>
                                <div><h3 class="font-bold text-slate-900 mb-2">Redonner du temps</h3><p class="text-slate-500 text-sm leading-relaxed">Chaque heure économisée sur l'administration est une heure investie dans la croissance, l'innovation et vos clients.</p></div>
                            </div>
                            <div class="group flex items-start gap-5 bg-white hover:bg-slate-50 rounded-2xl p-6 border border-slate-200 hover:border-slate-300 transition-all duration-200 shadow-sm hover:shadow-md">
                                <div class="w-12 h-12 bg-blue-50 group-hover:bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0 transition-colors"><i data-lucide="award" class="w-6 h-6 text-blue-600"></i></div>
                                <div><h3 class="font-bold text-slate-900 mb-2">Créer de la valeur durable</h3><p class="text-slate-500 text-sm leading-relaxed">En soutenant concrètement les PME &amp; les Travailleurs Autonomes, nous contribuons à la prosperité économique du Québec et du Canada.</p></div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-20 pt-16 border-t border-slate-200">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                            <div class="group">
                                <p class="text-5xl font-bold text-blue-600 mb-3 group-hover:scale-110 transition-transform duration-200 inline-block">90%</p>
                                <p class="text-slate-900 font-medium mb-1">des entreprises canadiennes sont des PME &amp; Travailleurs Autonomes</p>
                                <p class="text-slate-500 text-sm">Selon Statistiques Canada</p>
                            </div>
                            <div class="group">
                                <p class="text-5xl font-bold text-blue-600 mb-3 group-hover:scale-110 transition-transform duration-200 inline-block">20h+</p>
                                <p class="text-slate-900 font-medium mb-1">économisées par mois en administration</p>
                                <p class="text-slate-500 text-sm">Par entrepreneur en moyenne</p>
                            </div>
                            <div class="group">
                                <p class="text-5xl font-bold text-blue-600 mb-3 group-hover:scale-110 transition-transform duration-200 inline-block">#1</p>
                                <p class="text-slate-900 font-medium mb-1">solution IA d'administration au Canada</p>
                                <p class="text-slate-500 text-sm">Première plateforme intégrée</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- ============ FINAL CTA (bf) ============ -->
            <section id="cta" class="bg-white py-24 lg:py-32">
                <div class="max-w-7xl mx-auto px-6 lg:px-8">
                    <div class="relative bg-gradient-to-br from-blue-700 via-blue-600 to-sky-500 rounded-3xl overflow-hidden">
                        ...
                        <div class="absolute top-0 left-1/3 w-96 h-96 bg-white/8 rounded-full blur-3xl"></div>
                        <div class="absolute bottom-0 right-1/4 w-64 h-64 bg-sky-300/15 rounded-full blur-3xl"></div>
                        <div class="relative px-8 py-16 lg:px-16 lg:py-24 text-center">
                            <div class="inline-flex items-center gap-2 bg-white/15 border border-white/25 text-white text-sm font-medium px-4 py-2 rounded-full mb-8"><i data-lucide="zap" class="w-4 h-4 fill-white"></i>Devenez un leader</div>
                            <h2 class="text-3xl md:text-4xl lg:text-6xl font-bold text-white tracking-tight mb-6 max-w-4xl mx-auto leading-tight">Prêt à transformer votre gestion financière ?</h2>
                            <p class="text-lg lg:text-xl text-sky-100 mb-12 max-w-2xl mx-auto leading-relaxed">Rejoignez les premières PME &amp; Travailleurs Autonomes qui font confiance à 60sec-AI pour automatiser leur administration — et reprendre le contrôle de leur temps.</p>
                            <form class="flex justify-center mb-8">
                                <a data-nav="accueil" href="#plans" class="group inline-flex items-center justify-center gap-2 bg-white hover:bg-sky-50 text-blue-700 font-bold px-10 py-4 rounded-xl transition-all duration-200 hover:shadow-2xl hover:shadow-blue-900/20 hover:-translate-y-0.5 whitespace-nowrap text-base">Démarrer<i data-lucide="arrow-right" class="w-5 h-5 group-hover:translate-x-1 transition-transform"></i></a>
                            </form>
                            <div class="flex flex-wrap items-center justify-center gap-6 text-sm text-sky-100/80">
                                <div class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-white rounded-full"></div>Configuration en moins de 10 minutes</div>
                                <div class="flex items-center gap-2"><div class="w-1.5 h-1.5 bg-white rounded-full"></div>Support en français inclus</div>
                            </div>
                        </div>
                    </div>
                </div>
