-- =============================================================================
-- T239 — Le registre et le vidage rattrapent les nouvelles tables
--
-- Neuf tables sont nées avec T236 et T237. Sans ce script, le bouton « Vider la
-- préparation » les laisserait derrière lui — et un vidage qui ne vide pas tout
-- est pire qu'un vidage absent : on croit repartir propre.
-- =============================================================================
