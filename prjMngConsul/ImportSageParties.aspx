<%@ Page Language="VB" AutoEventWireup="false" MasterPageFile="~/Site.Master"
    CodeBehind="ImportSageParties.aspx.vb" Inherits="MngConsul.ImportSageParties" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="toolbar">
        <div class="pg-header">
            ...
            <div>
                <h1>Import Clients / Fournisseurs</h1>
                <div class="pg-sub">Migration Sage 50 → staging.SageParties</div>
            </div>
        </div>
    </div>
    ...
    <asp:Panel ID="pnlUpload" runat="server">
        <div class="imp-section">
            ...
            <p class="sec-desc">Exportez depuis Sage 50 : <strong>Reports &gt; Lists &gt; Customers / Vendors</strong></p>
    ...
    <div class="imp-section">
        ...
        <table class="map-tbl">
            ...
            <tbody>
                <tr><td class="c-csv">Name / Nom</td><td class="c-arr">→</td><td class="c-db">SageName</td><td>VARCHAR(500)</td><td>Nom du tiers</td></tr>
                <tr><td class="c-csv">Type</td><td class="c-arr">→</td><td class="c-db">SageType</td><td>VARCHAR(20)</td><td>Client ou Fournisseur</td></tr>
                <tr><td class="c-csv">Contact Name</td><td class="c-arr">→</td><td class="c-db">SageContactName</td><td>VARCHAR(200)</td><td>Nom du contact</td></tr>
                <tr><td class="c-csv">Address 1</td><td class="c-arr">→</td><td class="c-db">SageAddress1</td><td>VARCHAR(500)</td><td>Adresse ligne 1</td></tr>
                <tr><td class="c-csv">Address 2</td><td class="c-arr">→</td><td class="c-db">SageAddress2</td><td>VARCHAR(500)</td><td>Adresse ligne 2</td></tr>
                <tr><td class="c-csv">City / Ville</td><td class="c-arr">→</td><td class="c-db">SageCity</td><td>VARCHAR(50)</td><td>Ville</td></tr>
                <tr><td class="c-csv">Province</td><td class="c-arr">→</td><td class="c-db">SageProvince</td><td>VARCHAR(50)</td><td>Province / État</td></tr>
                <tr><td class="c-csv">Postal Code</td><td class="c-arr">→</td><td class="c-db">SagePostalCode</td><td>VARCHAR(20)</td><td>Code postal</td></tr>
                <tr><td class="c-csv">Phone</td><td class="c-arr">→</td><td class="c-db">SagePhone</td><td>VARCHAR(200)</td><td>Téléphone</td></tr>
                <tr><td class="c-csv">Email</td><td class="c-arr">→</td><td class="c-db">SageEmail</td><td>VARCHAR(200)</td><td>Courriel</td></tr>
                <tr><td class="c-csv">GST/TPS Number</td><td class="c-arr">→</td><td class="c-db">SageTPS</td><td>VARCHAR(20)</td><td>No TPS</td></tr>
                <tr><td class="c-csv">QST/TVQ Number</td><td class="c-arr">→</td><td class="c-db">SageTVQ</td><td>VARCHAR(20)</td><td>No TVQ</td></tr>
                <tr><td class="c-csv">Balance</td><td class="c-arr">→</td><td class="c-db">SageBalance</td><td>DECIMAL(15,2)</td><td>Solde</td></tr>
                <tr><td class="c-csv">Auxiliary Account</td><td class="c-arr">→</td><td class="c-db">SageCompteAux</td><td>VARCHAR(20)</td><td>Compte auxiliaire</td></tr>
            </tbody>
        </table>
    </div>
