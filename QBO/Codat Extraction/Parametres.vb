...
''' %APPDATA%\60sec\CodatExtraction\parametres.json.
'''
''' La clé d'API Codat ouvre les données comptables de toutes les sociétés du
''' compte : elle est chiffrée pour l'utilisateur Windows courant (DPAPI).
''' </summary>
Public Class Parametres
    ...
    Private Shared ReadOnly Entropie As Byte() = Encoding.UTF8.GetBytes("60sec.CodatExtraction")

    Private Shared ReadOnly Property Chemin As String
        Get
            Return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData),
                                "60sec", "CodatExtraction", "parametres.json")
        End Get
    End Property
