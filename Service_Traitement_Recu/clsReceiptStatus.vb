...
Public Class clsReceiptStatus
    ...
    ''' <summary>Etape courante de la boucle : 0 arret, 1 demarrage, 2 attente, 3 traitement.</summary>
    ...
    Private _LastReceipt As String = "Jamais"
    ''' <summary>Nom du dernier fichier traite.</summary>
    ...
    ''' <summary>Nombre de recus restant a traiter au dernier passage.</summary>
    ...
    ''' fichier) sont donc nettoyes ici. Les sauts de ligne aussi, sinon la
    ''' ligne serait coupee en deux a la lecture (StreamReader.ReadLine).
    ''' </summary>
