...
<asp:Content ContentPlaceHolderID="Contenu" runat="server">
    ...
    <p class="note">Les employés sont partagés avec 60Sec : créez-les ici ou là-bas, leur identité (nom, adresse, poste, date d'embauche) se modifie dans 60Sec.
    ...
    <div class="carte table-defilante">
        ...
        <asp:Label ID="lblAucun" runat="server" CssClass="note" Visible="false" Text="Aucun employé pour cette compagnie. Créez le premier avec le bouton ci-dessus, ou ajoutez-les dans 60Sec." />
    </div>
</asp:Content>
