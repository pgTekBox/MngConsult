...
'''   - Traitement : le deroulement normal (une tache prise, une tache finie)
...
Public Class clsLog
    ...
    Public Const logEventFileExecuteur = "EventExecuteur.txt"
    Public Const logErrorFileExecuteur = "ErrorExecuteur.txt"
    ...
    Private Shared Function FileFor(theLog As LogType) As String
        If theLog = LogType.Erreur Then
            Return PathOf(logErrorFileExecuteur)
        Else
            Return PathOf(logEventFileExecuteur)
        End If
    End Function
    ...
    Public Shared Sub ErrorWritelog(message As String, theLog As LogType)
        ...
        Append(message, PathOf(logErrorFileExecuteur))
    End Sub
