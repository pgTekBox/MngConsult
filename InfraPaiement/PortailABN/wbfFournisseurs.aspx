...
<asp:Content ID="cMain" ContentPlaceHolderID="MainContent" runat="server">
    <div class="page-head">
        ...
        <div><a href="wbfFournisseur.aspx" class="btn btn-primary">+ Ajouter un fournisseur</a></div>
    </div>
    ...
    <div class="table-wrap">
        <asp:Repeater ID="rpt" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    <td><a class="rowlink" href='wbfFournisseur.aspx?id=<%# Eval("Id") %>'><%# Enc(Eval("Nom")) %></a></td>
                    ...
                    <td><a href='wbfFournisseur.aspx?id=<%# Eval("Id") %>'>Modifier</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate></tbody></table></FooterTemplate>
        </asp:Repeater>
        <asp:Panel ID="pnlEmpty" runat="server" Visible="false" CssClass="empty">Aucun fournisseur. Cliquez « + Ajouter un fournisseur ».</asp:Panel>
    </div>
</asp:Content>
