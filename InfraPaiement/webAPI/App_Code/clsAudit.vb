...
''' <summary>
''' Journal d'audit des actions sensibles (T070AuditLog). Copie alignee sur
''' PortailMaster : l'echec d'ecriture d'audit est journalise mais ne fait
''' pas echouer l'action metier (best-effort).
''' </summary>
