<%@ Page Language="vb" AutoEventWireup="false"
    CodeBehind="wbfLogin.aspx.vb" Inherits="PortailPartenaire.wbfLogin" %>
...
<head runat="server">
    ...
    <title>Connexion — Espace partenaire 60secPaiement</title>
    ...
    <form id="form1" runat="server">
        <div class="login-card">
            <div class="login-header">
                ...
                <p class="login-sub">Provisionnez et gérez vos abonnés EFT</p>
            </div>
            ...
            <div class="login-body">
                ...
                <div class="field">
                    ...
                    <asp:TextBox ID="tbEmail" runat="server" TextMode="Email"
                        autofocus="autofocus" placeholder="vous@partenaire.ca" />
                </div>
            ...
            <div class="login-footer">
                © 2026 60secPaiement — Espace réservé aux partenaires
            </div>
        </div>
    </form>
</body>
