...
Module modController
    ...
    Public Sub MainGoControleur()
        Try
            ...
            mobServiceController = New System.ServiceProcess.ServiceController(tkbService.TkbServiceName)
            ...
            clsTaskMail.EventWritelog("Démarage du controleur: " & tkbService.TkbDisplayName)
        ...
        Catch obEx As Exception
            ...
            clsTaskMail.ErrorWritelog("1 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & vbCrLf & obEx.Message)
    ...
    Private Sub SetUpTimer()
        ...
        Catch obEx As Exception
            ...
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("2 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
    ...
    Private Sub CreateMenu()
        Try
            ...
            mobContextMenu.MenuItems.Add(New MenuItem("Preference", New EventHandler(AddressOf ShowForm1)))
        ...
        Catch obEx As Exception
            ...
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("3 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
    ...
    Private Sub GetServiceStatus()
        Try
            ...
            Select Case mobServiceController.Status()
                Case ServiceProcess.ServiceControllerStatus.Paused
                    mobNotifyIcon.Icon = My.Resources.Paused  'New Icon("Paused.ico")
                ...
                Case ServiceProcess.ServiceControllerStatus.Running
                    mobNotifyIcon.Icon = My.Resources.Running  ' New Icon("Running.ico")
                ...
                Case ServiceProcess.ServiceControllerStatus.Stopped
                    mobNotifyIcon.Icon = My.Resources.Stopped  ' New Icon("Stopped.ico")
                    mobContextMenu.MenuItems(0).Enabled = False
                    mobContextMenu.MenuItems(1).Enabled = False
                    mobContextMenu.MenuItems(2).Enabled = False
        ...
        Catch obEx As Exception
            ...
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("4 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
        ...
        Try
            If mobServiceController.Status = ServiceProcess.ServiceControllerStatus.Running Then
                If mobServiceController.CanStop = True Then
                    ...
                    clsTaskMail.EventWritelog("Demande d'arrêt du service par le controleur.")
                End If
            End If
        Catch obEx As Exception
          
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("5 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
        ...
        Try
            If Not mobServiceController.Status = ServiceProcess.ServiceControllerStatus.Paused = True Then
                If mobServiceController.CanPauseAndContinue = True Then
                    ...
                    clsTaskMail.EventWritelog("Demande de service en mode Pause par le conroleur.")
                End If
            End If
        Catch obEx As Exception
            ...
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("6 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
        ...
        Try
            If mobServiceController.Status = ServiceProcess.ServiceControllerStatus.Paused = True Then
                If mobServiceController.CanPauseAndContinue = True Then
                    ...
                    clsTaskMail.EventWritelog("Demande de service en mode Continue par le controleur.")
                End If
            End If
        Catch obEx As Exception
          
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("7 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
    ...
    Private Sub StartService(ByVal sender As Object, ByVal e As EventArgs)
        Try
            If mobServiceController.Status = ServiceProcess.ServiceControllerStatus.Stopped Then
                ...
                clsTaskMail.EventWritelog("Demande de démarage du service par le controleur.")
            End If
        Catch obEx As Exception
         
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("8 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
    ...
    Private Sub AboutBox(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            With obStringBuilder
                .Append("TekBox Service Controller ")
                .Append(vbCrLf)
                .Append("CLR Version: ")
        ...
        Catch obEx As Exception
            ...
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("9 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
    ...
    Private Sub ExitController(ByVal sender As Object, ByVal e As EventArgs)
        Try
            ...
            clsTaskMail.EventWritelog("Arrêt du controleur.")
        ...
        Catch obEx As Exception
            ...
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("10 - Erreur du controleur: " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
    ...
    Public Sub mobTimer_Elapsed(ByVal sender As Object, ByVal e As System.Timers.ElapsedEventArgs) Handles mobTimer.Elapsed
        ...
        Catch obEx As Exception
            ...
            '    ' Write an informational entry to the event log.    
            clsTaskMail.ErrorWritelog("11 - Erreur du controleur. Le service ne semble plus répondre au demande du controleur. Le controleur est arrêté. " & tkbService.TkbDisplayName & vbCrLf & obEx.Message)
