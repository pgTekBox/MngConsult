<%@ Page Language="vb" AutoEventWireup="false" EnableViewState="true"
    CodeBehind="wbfUserEdit.aspx.vb" Inherits="prjSec60Admin.wbfUserEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="wrap">
            ...
            <div class="top">
                <div>
                    <div class="title">
                        <asp:Literal ID="litTitle" runat="server" Text="Nouvel utilisateur" />
                    </div>
                    <div class="sub">Gérez les informations et l'accès de l'utilisateur.</div>
                </div>
                <div class="bar">
            ...
            <div class="card">
                ...
                <div class="cardBody">
                    ...
                    <div class="grid">
                        <div class="field">
                            <label>
                                <asp:Literal ID="litPasswordLabel" runat="server" Text="Mot de passe *" />
                            </label>
                            <telerik:RadTextBox ID="txtPassword" runat="server"
                                TextMode="Password"
                                RenderMode="Lightweight" CssClass="rtbLike" />
                            <div class="hint">
                                <asp:Literal ID="litPasswordHint" runat="server"
                                    Text="Minimum 8 caractères." />
                            </div>
                        </div>
                        <div class="field">
                            <label>Confirmation du mot de passe</label>
                            <telerik:RadTextBox ID="txtPasswordConfirm" runat="server"
                                TextMode="Password"
                                RenderMode="Lightweight" CssClass="rtbLike" />
                        </div>
                    </div>
                ...
                <div class="cardBody">
                    ...
                    <div class="grid">
                        <div class="field">
                            ...
                            <div class="hint">
                                Les administrateurs peuvent gérer les utilisateurs de la compagnie.
                            </div>
                        </div>
                        <div class="field">
                            <label>&nbsp;</label>
