...
Public Class wbfUserEdit
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            ' La compagnie est choisie dans wbfUsers.aspx (conservée en session).
            If Company = Guid.Empty Then
                ShowMsg("Aucune compagnie sélectionnée. Fermez et choisissez une compagnie dans la liste.", isError:=True)
            End If
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If Company = Guid.Empty Then
            ShowMsg("Aucune compagnie sélectionnée.", isError:=True)
            Return
        End If
